...
public class MavenPriemTesterTest {

    private final PriemTester priemTester = new MavenPriemTester();
    ...
    @ParameterizedTest
    @ValueSource(strings = {"101", "103", "1009", "104729", "1299709", "15485863", "32452843"})
